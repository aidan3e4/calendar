...
async def get_distance(
    ...
    async with Stealth().use_async(async_playwright()) as p:
        ...
        await page.goto("https://www.mapmyrun.com/auth/login/", wait_until="domcontentloaded", timeout=60000)
        ...
        await email_locator.click(force=True)  # force=True bypasses some visibility/actionability checks
        await email_locator.press_sequentially(os.environ["MAP_MY_RUN_EMAIL"], delay=80)  # slower delay for realism
        ...
        await password_locator.press_sequentially(os.environ["MAP_MY_RUN_PASSWORD"], delay=80)
        await page.evaluate("""
        ...
        await page.get_by_role("button", name="LOG IN").click()  # exact text match, case-sensitive
        ...
        if auth_token:
            ...
            params = {
                ...
                "started_after": "2026-01-01T00:00:00.000Z",
                "started_before": "2026-12-31T23:59:59.999Z",
                "limit": 1000
            }
            resp = session.get("https://www.mapmyrun.com/internal/allWorkouts/", params=params)
